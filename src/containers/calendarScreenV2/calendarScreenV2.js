...
export default class CalendarScreenV2 extends Component {
    constructor(props) {
        super(props);
        this.state = {
          items: {}
    ...
    loadItems(day) {
      ...
      renderItem(item) {
        return (
          <View style={[styles2.item, {height: item.height}]}><Text>{item.name}</Text></View>
        );
      }
    
      renderEmptyDate() {
        return (
          <View style={styles2.emptyDate}><Text>This is empty date!</Text></View>
        );
      }
